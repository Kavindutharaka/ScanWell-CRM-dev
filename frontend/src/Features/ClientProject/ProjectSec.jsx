      ...
      <div className="p-4 md:p-6 lg:p-8 max-w-[102rem] mx-auto pb-8">
        ...
        <div className={`flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6 ${!loading ? 'animate-fadeInUp' : 'opacity-0'}`} style={{ animationDelay: '100ms', animationFillMode: 'both' }}>
          ...
          <div className="flex flex-wrap items-center gap-2 lg:gap-3">
            ...
            {/* Profile */}
            <div className="bg-gradient-to-br from-green-500 to-green-600 text-white rounded-full w-9 h-9 flex items-center justify-center shadow-sm">
            ...
            <div className="flex items-center gap-1">
              ...
              >
                <Users className="w-4 h-4 text-green-500 group-hover:text-green-600" />
                <span className="hidden sm:inline">Invite</span>
                <span className="bg-green-100 text-green-700 px-1.5 py-0.5 rounded text-xs font-medium">1</span>
              </button>
              <button 
          ...
          <div className="flex-1 max-w-md ml-auto">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 text-sm"
              />
            </div>
          </div>
        </div>
        ...
        <div className="fixed bottom-6 right-6 z-30">
          <button
            ...
            className="bg-green-600 hover:bg-green-700 text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 group"

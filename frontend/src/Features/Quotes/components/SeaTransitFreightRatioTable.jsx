// components/SeaTransitFreightRatioTable.jsx
import { Plus, Trash2 } from 'lucide-react';
import AutocompleteInput from './AutocompleteInput';
import { getCarriersByCategory, currencySuggestions } from '../../../data/quoteData';
import { useState, useEffect } from 'react';

export default function SeaTransitFreightRatioTable({
  formData,
  setFormData,
  routeIdx,
  tableIdx,
  ...
  useEffect(() => {
    ...
    updated[routeIdx].seaFreightRatioChargesTables[tableIdx].charges = transformToVertical(horizontalData);
  ...
  return (
    <div className="space-y-4 mb-6 bg-white rounded-lg p-4 border border-gray-200">
      <div className="flex justify-between items-center border-b pb-2">
        <h3 className="text-lg font-medium text-gray-700">Air Freight Ratio Charges ({tableName})</h3>

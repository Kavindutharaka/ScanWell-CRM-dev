 ...
 */
export const generateDirectQuotePDF = (quoteData, userData = null) => {
  const doc = new jsPDF();
 ...
 */
export const generateTransitQuotePDF = (quoteData, userData = null) => {
  const doc = new jsPDF();
  let yPos = addPDFHeader(doc, quoteData);
 ...
 */
export const generateMultiModalQuotePDF = (quoteData, userData = null) => {
  const doc = new jsPDF();
  let yPos = addPDFHeader(doc, quoteData);

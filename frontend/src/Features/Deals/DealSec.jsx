...
export default function DealSec({ modalOpen, deals, loadDeals, error}) {
  ...
  useEffect(()=>{
    console.log("this is deals: ", deals);
  },[deals]);
  ...
  const filteredDeals = useMemo(() => {
    ...
    return deals.filter(deal => {
      ...
      const searchableFields = [
        ...
        deal.quotesInvoices,
        deal.stage,
        deal.forecastValue?.toString(),
        deal.name, // Add if you have this field
        deal.description, // Add if you have this field
      ];
  ...
  const handleRefresh = () => {
    setLoading(true);
    loadDeals(); // Reload deals from your data source
  ...
  return (
    <div className="w-full bg-gradient-to-br from-slate-50 to-emerald-50/30 min-h-full">
      ...
      <div className="p-4 md:p-6 lg:p-8 max-w-[102rem] mx-auto pb-8">
          ...
          <div className="flex-1 max-w-md ml-auto">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2.5 bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200 text-sm"
              />
              {/* Clear search button */}
              {searchQuery && (
                <button
        ...
        {/* Deals Content - Single Table Only */}
        <div className="space-y-6">
          ...
          {searchQuery && filteredDeals.length === 0 ? (
            ...
            <Deals 
              onOpen={modalOpen}
              deals={filteredDeals} // Pass filtered deals
              loadDeals={loadDeals}
              loading={loading}
              error={error}
              delay={300}

...
namespace back_end.Models
{
    public class QuoteCopy
    {
        ...
        public string rateValidity { get; set; }  // Added this field to match frontend
        ...
        public string? customTerms { get; set; } // JSON serialized from frontend (made nullable to fix null binding issue)
    }
}